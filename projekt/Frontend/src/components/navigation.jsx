...
export default function Navigation() {
  ...
  const getMobileNavLinkClass = ({ isActive }) => {
    return isActive
      ? 'bg-indigo-50 border-indigo-500 text-indigo-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium' // Active mobile style
      : 'border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium'; // Inactive mobile style
  };
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="-mr-2 flex items-center sm:hidden">
            <button
              ...
              // This button now toggles the state
